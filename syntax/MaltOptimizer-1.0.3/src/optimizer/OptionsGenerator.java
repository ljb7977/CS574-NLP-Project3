...
public class OptionsGenerator {
	...
	public OptionsGenerator(String language, boolean projective, String trainingCorpus, boolean danglingPunct, boolean rootGRL, String realRoot){
		...
		if (language.equals("en")){
			libValue="-s_0_-t_1_-d_2_-g_0.18_-c_0.4_-r_0.4_-e_1.0";
		}
		if (language.equals("es")){
			libValue="-s_0_-t_1_-d_2_-g_0.2_-c_0.5_-r_0_-e_0.01";
		}
	...
	public String generateTrainingCommand() {
		...
		return "java -jar malt.jar -f <options_file>.xml -F <feature_model>.xml";
	}
	
	public String generateTestingCommand() {
		// TODO Auto-generated method stub
		if (rootGRL && !danglingPunctuation)
			return "java -jar malt.jar -c "+modelName+" -i <test_corpus>.conll -o output.conll -m parse";
		
		if (!rootGRL && !danglingPunctuation)
			return "java -jar malt.jar -c "+modelName+" -i <test_corpus>.conll -o output.conll -m parse -grl "+this.realRoot;
		
		if (rootGRL && danglingPunctuation)
			return "java -jar malt.jar -c "+modelName+" -i <test_corpus>.conll -o output.conll -m parse -pcr head";
		
		//if (rootGRL && danglingPunctuation)
		return "java -jar malt.jar -c "+modelName+" -i <test_corpus>.conll -o output.conll -m parse -grl "+this.realRoot+" -pcr head";
